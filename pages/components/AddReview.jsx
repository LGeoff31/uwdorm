...
const AddReview = ({
  ...
  const showToast = (message) => {
    ...
    `;
    // Adjust z-index to make the toast appear in front of other elements
  ...
  const showErrorToast = (message) => {
    const toast = document.createElement("div");
    toast.innerHTML = `
    <div id="toast-danger" class="fixed bottom-4 z-1 flex items-center w-max p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
