...
export default function contact() {
    return (
        <>
            ...
            <div
                style={{
                    background: `url('https://www.theme-junkie.com/wp-content/uploads/After-Effects-Background-Template-20.jpg') no-repeat center center fixed`,
            ...
            >
                ...
                <div className="p-20 ml-20"><div className="text-3xl font-bold">Welcome to UW Rez!:</div>
